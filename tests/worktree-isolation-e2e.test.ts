 ...
 * agent-startup-error) mock ../extensions/subagents/worktree.js entirely and assert only the gate
...
import { setWorktreeIsolationEnabled } from "../extensions/subagents/worktree.js";
import {
  agentCall,
  type FauxReply,
  type PrintModeRun,
