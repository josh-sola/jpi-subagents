// extensions/subagents/model-scope.ts had no test file. Its `error` verdict was reachable only
...
import type { ModelRegistryRef } from "../extensions/subagents/enabled-models.js";
import {
  checkModelScope,
  isScopeModelsEnabled,
  setScopeModelsEnabled,
} from "../extensions/subagents/model-scope.js";
