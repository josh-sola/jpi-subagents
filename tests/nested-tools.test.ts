...
import { setScopeModelsEnabled } from "../extensions/subagents/model-scope.js";
import {
  createNestedSubagentTools,
  getMaxSubagentDepth,
  type NestedAgentManager,
  setMaxSubagentDepth,
} from "../extensions/subagents/nested-tools.js";
import { encodeCwd } from "../extensions/subagents/output-file.js";
