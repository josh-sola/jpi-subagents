...
// The LOAD side (extensions/subagents/custom-agents.ts) parses that frontmatter with a real YAML
...
//
// These live in extensions/subagents/agent-file-toggle.ts rather than inside the `/agents`
...
import {
  ...
  isEmptyStub,
  locateAgentFile,
} from "../extensions/subagents/agent-file-toggle.js";
import { parseAgentFrontmatter } from "../extensions/subagents/custom-agents.js";
