...
vi.mock("../extensions/subagents/worktree.js", async () => {
  const actual = await vi.importActual<typeof import("../extensions/subagents/worktree.js")>(
    "../extensions/subagents/worktree.js",
  );
