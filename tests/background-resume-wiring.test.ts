...
vi.mock("../extensions/subagents/agent-runner.js", async () => {
  const actual = await vi.importActual<typeof import("../extensions/subagents/agent-runner.js")>(
    "../extensions/subagents/agent-runner.js",
  );
  return { ...actual, runAgent: vi.fn(), resumeAgent: vi.fn() };
});

vi.mock("../extensions/subagents/output-file.js", async () => {
  const actual = await vi.importActual<typeof import("../extensions/subagents/output-file.js")>(
    "../extensions/subagents/output-file.js",
  );
  return {
    ...actual,
...
import { resumeAgent, runAgent } from "../extensions/subagents/agent-runner.js";
import subagentsExtension from "../extensions/subagents/index.js";
import {
  ensureOutputFile,
  streamToOutputFile,
  writeInitialEntry,
} from "../extensions/subagents/output-file.js";
