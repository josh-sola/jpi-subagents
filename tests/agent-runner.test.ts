...
vi.mock("../extensions/subagents/agent-types.js", () => ({
...
vi.mock("../extensions/subagents/env.js", () => ({
  detectEnv: vi.fn(async () => ({ isGitRepo: false, branch: "", platform: "linux" })),
}));

vi.mock("../extensions/subagents/prompts.js", () => ({
  buildAgentPrompt: vi.fn(() => "system prompt"),
}));

vi.mock("../extensions/subagents/memory.js", () => ({
  buildMemoryBlock: vi.fn(() => ""),
  buildReadOnlyMemoryBlock: vi.fn(() => ""),
}));

vi.mock("../extensions/subagents/skill-loader.js", () => ({
  preloadSkills: vi.fn(() => []),
}));

vi.mock("../extensions/subagents/nested-tools.js", () => ({
...
import {
  ...
  setGraceTurns,
  setRememberAgents,
} from "../extensions/subagents/agent-runner.js";
...
describe("agent-runner final output capture", () => {
  ...
  it("forwards worktreeBase to the prompt builder, and omits it otherwise", async () => {
    const { buildAgentPrompt } = await import("../extensions/subagents/prompts.js");
...
import {
  ...
  getConfig,
  getToolNamesForType,
} from "../extensions/subagents/agent-types.js";
import { createNestedSubagentTools } from "../extensions/subagents/nested-tools.js";
